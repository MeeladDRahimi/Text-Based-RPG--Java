public class Story {
    ...
    public static void printIntroPartTwo() {
        ...
        GameLogic.anythingToContinue();
        GameLogic.clearConsole();
        System.out.println("\nDavaiel: Basically, you're shit out of luck and will rot in hell for eternity! Sorry bud!\n" + GameLogic.player.getName() + ": WHAT. THE. FU-");
        GameLogic.anythingToContinue();
        GameLogic.clearConsole();
        boldRedTextColor();
    ...
    public static void finalBossDialogue() {
        GameLogic.clearConsole();
        System.out.println("Generic Dialogue");
        GameLogic.anythingToContinue();
    }
